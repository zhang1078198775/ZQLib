...
public class BridgeWebView extends WebView implements WebViewJavascriptBridge {
	...
	private void init() {
		...
		String databasePath = BridgeWebView.this.getContext()
				.getDir("databases", Context.MODE_PRIVATE).getPath();
		this.getSettings().setDatabasePath(databasePath);

		/* HTML5离线缓存 */
		String appCachPath = BridgeWebView.this.getContext().getCacheDir()
				.getAbsolutePath();
		...
		progressBar = ProgressDialog.show(BridgeWebView.this.getContext(),
				null, "页面加载中，请稍后..");
