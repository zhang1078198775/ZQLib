...
import static cn.mobile.apphelper.common.utils.FileTool.getDataColumn;
import static cn.mobile.apphelper.common.utils.FileTool.isDownloadsDocument;
import static cn.mobile.apphelper.common.utils.FileTool.isExternalStorageDocument;
import static cn.mobile.apphelper.common.utils.FileTool.isGooglePhotosUri;
import static cn.mobile.apphelper.common.utils.FileTool.isMediaDocument;
...
public class PhotoTool {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            ToastTool.showShortToast(context,"请先获取写入SDCard权限");
        } else {
