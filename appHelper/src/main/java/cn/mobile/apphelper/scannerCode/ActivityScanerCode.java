...
import cn.mobile.apphelper.common.utils.AnimationTool;
import cn.mobile.apphelper.common.utils.BeepTool;
import cn.mobile.apphelper.common.utils.PhotoTool;
import cn.mobile.apphelper.common.utils.ToastTool;
import cn.mobile.apphelper.scannerCode.CameraManager;
import cn.mobile.apphelper.scannerCode.CaptureActivityHandler;
import cn.mobile.apphelper.scannerCode.InactivityTimer;
import cn.mobile.apphelper.scannerCode.OnScanerListener;
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            try {
                ...
                if (rawResult != null) {
                    ...
                    if (mScanerListener == null) {
                        ToastTool.showShortToast(this,"图片识别失败");
                    } else {
...
//        }
    ...
    public void handleDecode(Result result) {
        ...
        //扫描成功之后的振动与声音提示
        BeepTool.playBeep(this, vibrate);

        String result1 = result.getText();
        Log.v("二维码/条形码 扫描结果", result1);
        if (mScanerListener == null) {
            ToastTool.showShortToast(this,result1);
